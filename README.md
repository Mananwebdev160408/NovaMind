...
| **Storage** | IndexedDB + OPFS | Persistent local data |
| **Frontend** | React + TypeScript | UI framework |
| **Build** | Vite | Fast bundling & dev server |
| **Deployment** | Vercel | Static hosting with COOP/COEP headers |
...
### First-Time Setup
1. The app will automatically download AI models (~250MB for LFM2-350M)
2. Models are cached in your browser's OPFS storage
3. After download, the app works 100% offline
...
- **AI SDK**: RunAnywhere Web SDK (beta)
- **Storage**: IndexedDB (via custom wrapper)
- **Build**: Vite 6 with custom WASM plugin
- **Models**: 
  - LLM: Liquid AI LFM2-350M (GGUF)
...
✅ **All AI runs locally** via WebAssembly  
✅ **No external API calls** for inference  
✅ **No analytics** or tracking  
✅ **No telemetry** of any kind  
✅ **Data stays in browser** (IndexedDB + OPFS)  
✅ **Works 100% offline** after model download  
✅ **Verifiable** via network inspector  
